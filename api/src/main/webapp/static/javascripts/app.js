...
module.exports = {
  load: function load(id) {
    movieServices.getMovieViewById(id).then(function (data) {
      AppDispatcher.handleServerAction({
        data: { movie: data },
        type: "update"
      });
  ...
  loadCastings: function loadCastings(id) {
    movieServices.getMovieCastingsById(id).then(function (data) {
      AppDispatcher.handleServerAction({
        data: { castings: data },
        type: "update"
      });
  ...
  loadProducers: function loadProducers(id) {
    movieServices.getMovieProducersById(id).then(function (data) {
      AppDispatcher.handleServerAction({
        data: { producers: data },
        type: "update"
      });
  ...
  loadDirectors: function loadDirectors(id) {
    movieServices.getMovieDirectorsById(id).then(function (data) {
      AppDispatcher.handleServerAction({
        data: { directors: data },
        type: "update"
      });
  ...
  save: function saveMovie(jsonMovie) {
    ...
    return movieServices.updateMovie(jsonMovie).then(function (data) {
      AppDispatcher.handleServerAction({
        data: { movie: data },
        type: "update"
      });
...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement("div", null, React.createElement(AppHeader, null, React.createElement("div", { className: "content-bar" }, React.createElement("div", { className: "real-bar" }, React.createElement("div", { className: "actions-left" },
    ...
    React.createElement(Cartouche, { className: "entete-tall" })), React.createElement("div", { className: "entete-actions" }, React.createElement("button", { className: "btn btn-success btn-fab btn-raised fa fa-bell-o" }), React.createElement("button", { className: "btn btn-danger btn-fab btn-raised fa fa-eye" }), React.createElement("button", { className: "btn btn-primary btn-fab btn-raised fa fa-user" }))));
  }
});
});
...
var Menu = React.createClass({
  ...
  renderContent: function renderMenuContent() {
    var home = React.createElement(
      'a',
      { onClick: this.handleNaviagtion, 'data-action': '#' },
      React.createElement('img', { src: 'static/img/home-32x32-white.svg' })
    );
    var search = React.createElement(
      'a',
      { onClick: this.openQuickSearchPopin, id: 'quick-search-link' },
  ...
  handleNaviagtion: function handleNaviagtion(event) {
    event.preventDefault();
...
var Menu = React.createClass({
  ...
  renderContent: function renderMenuContent() {
    return React.createElement(
      'div',
      { className: 'top-menu-items-container' },
      React.createElement(
        'div',
...
module.exports = React.createClass({
  ...
  render: function renderTopMenu() {
    var links = [{ url: '', name: '', img: 'static/img/home-32x32-white.svg' }, { url: '', name: '', img: 'static/img/search-32x32-white.svg' }, { url: '', name: '', img: 'static/img/search-32x32-white.svg', style: { className: 'user' } }];
    return React.createElement(Menu, {
      open: true,
      position: this.props.position,
      direction: this.props.direction,
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'picture' },
                    React.createElement('img', { src: './static/img/logoMovie.png', width: '100%', height: '100%' })
                ),
                React.createElement(
                    'div',
                    { className: 'title' },
...
module.exports = React.createClass({
  ...
  renderContent: function renderContentCastings() {
    return React.createElement(
      Block,
      { title: 'CAST', style: { className: 'slidingBlock', titleId: 'cast' } },
...
module.exports = React.createClass({
  ...
  renderContent: function render() {
    return React.createElement(
      ...
      React.createElement(
        Block,
        { title: 'DETAILS', style: { className: 'slidingBlock', titleId: 'details' } },
        this._renderActions(),
      ...
      React.createElement(
        Block,
        { title: 'STORYLINE', style: { className: 'slidingBlock', titleId: 'storyline' } },
...
module.exports = React.createClass({
  ...
  renderContent: function render() {
    return React.createElement(
      Block,
      { title: 'DIRECTORS', style: { className: 'slidingBlock', titleId: 'directors' } },
...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(Block, { title: "PICTURES", style: { className: "slidingBlocK noBorderBottom", titleId: "pictures" } });
  }
});
});
...
module.exports = React.createClass({
  ...
  renderContent: function render() {
    return React.createElement(
      Block,
      { title: 'PRODUCERS', style: { className: 'slidingBlock', titleId: 'producers' } },
