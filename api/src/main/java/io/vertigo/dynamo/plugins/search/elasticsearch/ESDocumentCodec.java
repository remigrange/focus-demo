...
final class ESDocumentCodec {
     ...
     */
    <I extends DtObject, R extends DtObject> SearchIndex<I, R> searchHit2Index(
            final SearchIndexDefinition indexDefinition, final SearchHit searchHit) {
     ...
     */
    <I extends DtObject, R extends DtObject> XContentBuilder index2XContentBuilder(final SearchIndex<I, R> index,
            final SearchIndexFieldNameResolver indexFieldNameResolver) throws IOException {
