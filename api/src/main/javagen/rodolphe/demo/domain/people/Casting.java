...
public final class Casting implements DtObject {
     ...
     */
    @io.vertigo.dynamo.domain.stereotype.Association(name = "A_CAST_PEO", fkFieldName = "PEO_ID",
            primaryDtDefinitionName = "DT_PEOPLE", primaryIsNavigable = true, primaryRole = "People",
            primaryLabel = "People", primaryMultiplicity = "1..1", foreignDtDefinitionName = "DT_CASTING",
            foreignIsNavigable = false, foreignRole = "Casting", foreignLabel = "Casting", foreignMultiplicity = "0..*")
    public rodolphe.demo.domain.people.People getPeople() {
        ...
        if (people != null) {
            ...
            uri = new io.vertigo.dynamo.domain.model.URI<>(
                    io.vertigo.dynamo.domain.util.DtObjectUtil.findDtDefinition(people),
                    io.vertigo.dynamo.domain.util.DtObjectUtil.getId(people));
            if (!fkURI.toURN().equals(uri.toURN())) {
                people = null;
            }
        }
        if (people == null) {
            people = io.vertigo.core.Home.getComponentSpace()
                    .resolve(io.vertigo.dynamo.persistence.PersistenceManager.class).getBroker().get(fkURI);
        }
        return people;
    }
    ...
    public io.vertigo.dynamo.domain.model.URI<rodolphe.demo.domain.people.People> getPeopleURI() {
        return DtObjectUtil.createURI(this, "A_CAST_PEO", rodolphe.demo.domain.people.People.class);
    }
     ...
     */
    @io.vertigo.dynamo.domain.stereotype.Association(name = "A_CAST_MOV", fkFieldName = "MOV_ID",
            primaryDtDefinitionName = "DT_MOVIE", primaryIsNavigable = true, primaryRole = "Movie",
            primaryLabel = "Movie", primaryMultiplicity = "1..1", foreignDtDefinitionName = "DT_CASTING",
            foreignIsNavigable = false, foreignRole = "Casting", foreignLabel = "Casting", foreignMultiplicity = "0..*")
    public rodolphe.demo.domain.movies.Movie getMovie() {
        ...
        if (movie != null) {
            ...
            uri = new io.vertigo.dynamo.domain.model.URI<>(
                    io.vertigo.dynamo.domain.util.DtObjectUtil.findDtDefinition(movie),
                    io.vertigo.dynamo.domain.util.DtObjectUtil.getId(movie));
            if (!fkURI.toURN().equals(uri.toURN())) {
                movie = null;
            }
        }
        if (movie == null) {
            movie = io.vertigo.core.Home.getComponentSpace()
                    .resolve(io.vertigo.dynamo.persistence.PersistenceManager.class).getBroker().get(fkURI);
        }
        return movie;
    }
    ...
    public io.vertigo.dynamo.domain.model.URI<rodolphe.demo.domain.movies.Movie> getMovieURI() {
        return io.vertigo.dynamo.domain.util.DtObjectUtil.createURI(this, "A_CAST_MOV",
                rodolphe.demo.domain.movies.Movie.class);
    }
     ...
     */
    @io.vertigo.dynamo.domain.stereotype.Association(name = "A_CAST_RLP", fkFieldName = "RLM_CD",
            primaryDtDefinitionName = "DT_ROLE_MOVIE", primaryIsNavigable = true, primaryRole = "RoleMovie",
            primaryLabel = "Role movie", primaryMultiplicity = "1..1", foreignDtDefinitionName = "DT_CASTING",
            foreignIsNavigable = false, foreignRole = "Casting", foreignLabel = "Casting", foreignMultiplicity = "0..*")
    public rodolphe.demo.domain.masterdatas.RoleMovie getRoleMovie() {
        ...
        if (roleMovie != null) {
            ...
            uri = new io.vertigo.dynamo.domain.model.URI<>(
                    io.vertigo.dynamo.domain.util.DtObjectUtil.findDtDefinition(roleMovie),
                    io.vertigo.dynamo.domain.util.DtObjectUtil.getId(roleMovie));
            if (!fkURI.toURN().equals(uri.toURN())) {
                roleMovie = null;
            }
        }
        if (roleMovie == null) {
            roleMovie = io.vertigo.core.Home.getComponentSpace()
                    .resolve(io.vertigo.dynamo.persistence.PersistenceManager.class).getBroker().get(fkURI);
        }
        return roleMovie;
    }
    ...
    public io.vertigo.dynamo.domain.model.URI<rodolphe.demo.domain.masterdatas.RoleMovie> getRoleMovieURI() {
        return io.vertigo.dynamo.domain.util.DtObjectUtil.createURI(this, "A_CAST_RLP",
                rodolphe.demo.domain.masterdatas.RoleMovie.class);
    }
