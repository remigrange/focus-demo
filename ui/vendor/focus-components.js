...
},{"../../common/icon":32,"../../mixin/stylable":78,"../mixin/popin-behaviour":13}],12:[function(require,module,exports){
"use strict";
...
var buttonMixin = {
    ...
    _renderIcon: function renderIcon() {
        if (this.props.icon) {
            return React.createElement(Icon, { name: this.props.icon, prefix: "mdi-" });
        }
        return "";
    },
